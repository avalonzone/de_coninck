...
class WineName extends Base
{
    ...
    protected static $names = ["Château", "Domaine", "Vignoble", "Cuvée", "Réserve", "Millésime", "Clos", "Champagne", "Prestige", "Terroir", "Coteaux", "Grenache", "Merlot", "Pinot", "Cabernet", "Syrah", "Bordeaux", "Beaujolais", "Chardonnay", "Sauvignon", "Rouge", "Blanc", "Noir", "Blanc de Blancs", "Blanc de Noirs", "Brut", "Sec", "Doux", "Sec", "Fruité", "Épicé", "Velouté", "Corsé", "Léger", "Riche", "Moelleux", "Champêtre", "Montagneux", "Méditerranéen", "Côtes", "Vallée", "Colline", "Lac", "Cascade", "Rivière", "Forêt", "Plaine", "Plateau"];
