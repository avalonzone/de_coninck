            ...
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class='col-6'>
                        ...
                        <select class="form-select" aria-label="Cépage ?" id="inputWineGrapeId" name="grape" {{ request()->routeIs('wines.show') ? 'disabled' : '' }}>
                    ...
                    <div class='col-6'>
                        ...
                        <select class="form-select" aria-label="Type ?" id="inputWineTypeId" name="type" {{ request()->routeIs('wines.show') ? 'disabled' : '' }}>
